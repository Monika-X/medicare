        ...
        this.innerHTML = `
            <nav class="navbar" id="navbar">
                <div class="nav-inner">
                    ...
                    <div class="nav-actions">
                        <a href="${_p('login.html')}"   class="btn btn-outline">Log In</a>
            ...
            <div class="mobile-nav" id="mobile-nav">
                ...
                <div class="mobile-nav-links">
                    ...
                    <a href="${_p('login.html')}"             style="animation-delay:0.40s"><i class="fa-solid fa-user"></i> Log In</a>
                </div>
                    ...
                    <div class="footer-grid">
                        ...
                        <div class="footer-col brand-col">
                            ...
                            <div class="footer-socials">
                                <a href="#" class="social-icon hover-lift" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                                <a href="#" class="social-icon hover-lift" aria-label="Twitter"><i class="fa-brands fa-twitter"></i></a>
                                <a href="#" class="social-icon hover-lift" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                                <a href="#" class="social-icon hover-lift" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="footer-col">
                            ...
                            <div class="footer-contact-list">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-text">123 Medical Boulevard,<br>Health City, HC 10020</div>
                                </div>
                                <div class="contact-item">
                                    <div class="contact-icon"><i class="fa-solid fa-phone"></i></div>
                                    <div class="contact-text">+1 (800) 123-4567<br>+1 (800) 987-6543</div>
                                </div>
                                <div class="contact-item">
                                    <div class="contact-icon"><i class="fa-solid fa-envelope"></i></div>
                                    <div class="contact-text">info@medicarediagnostics.com</div>
                                </div>
                            </div>
                        </div>
